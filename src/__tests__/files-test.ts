...
test('normalize8baseDocumentCreate:', () => {
  expect(() => normalize8baseDocumentCreate({}, '')).toThrowError(
    new ValidationError(
      `normalize8baseDocumentCreate:key: value: can't be blank, null or undefined.`,
    ),
  );
  ...
  expect(o8).toEqual({
    a: { create: { fileId: '<ID>', filename: '<FILENAME>' } },
  });
});
...
test('normalize8baseDocumentsCreate:', () => {
  expect(() => normalize8baseDocumentsCreate({}, '')).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsCreate:key: value: can't be blank, null or undefined.`,
    ),
  );
  ...
  expect(() => normalize8baseDocumentsCreate(o6, 'a')).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsCreate:currentValues: object is not a valid file as it doesn't contain a valid fileId property.`,
    ),
  );
  ...
  const o9 = {
    a: [
      { fileId: '<ID1>', filename: '<FILENAME1>' },
      { fileId: '<ID2>', filename: '<FILENAME2>' },
    ],
  };
  ...
  expect(() => normalize8baseDocumentsCreate(o10, 'a')).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsCreate:currentValues: object is not a valid file as it doesn't contain a valid filename property.`,
    ),
  );
});
...
test('normalize8baseDocumentsCreateItems:', () => {
  expect(() => normalize8baseDocumentsCreateItems({}, '')).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsCreateItems:key: value: can't be blank, null or undefined.`,
    ),
  );
  ...
  expect(() => normalize8baseDocumentsCreateItems(o6, 'a')).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsCreateItems:currentValues: object is not a valid file as it doesn't contain a valid fileId property.`,
    ),
  );
  ...
  expect(() => normalize8baseDocumentsCreateItems(o10, 'a')).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsCreateItems:currentValues: object is not a valid file as it doesn't contain a valid filename property.`,
    ),
  );
});
...
test('normalize8baseDocumentDeleteAndUpdate:', () => {
  expect(() => normalize8baseDocumentDeleteAndUpdate({}, '', {})).toThrowError(
    new ValidationError(
      `normalize8baseDocumentDeleteAndUpdate:key: value: can't be blank, null or undefined.`,
    ),
  );
  ...
  const oldO3 = { a: 1 };
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(newO3, 'a', oldO3),
  ).toThrowError(
    new ValidationError(
  ...
  const oldO4 = { a: '1' };
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(newO4, 'a', oldO4),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentDeleteAndUpdate:oldFile: object is not a valid reference as it doesn't contain a valid id property.`,
    ),
  ...
  const oldO5 = { a: {} };
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(newO5, 'a', oldO5),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentDeleteAndUpdate:oldFile: object is not a valid reference as it doesn't contain a valid id property.`,
    ),
  ...
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(newO6, 'a', oldO6),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentDeleteAndUpdate:oldFile: object is not a valid reference as it doesn't contain a valid id property.`,
    ),
  ...
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(newO7, 'a', oldO7),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentDeleteAndUpdate:oldFile: object is not a valid reference as it doesn't contain a valid id property.`,
    ),
  ...
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(newO9, 'a', oldO9),
  ).toThrowError(
    new ValidationError(
  ...
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(new10, 'a', old10),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentDeleteAndUpdate:newFile: object is not a valid file as it doesn't contain a valid fileId property.`,
    ),
  ...
  const old11 = {};
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(new11, 'a', old11),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentDeleteAndUpdate:newFile: object is not a valid file as it doesn't contain a valid fileId property.`,
    ),
  ...
  expect(new12).toEqual({
    a: { create: { fileId: 'FILE-ID1', filename: '<FILENAME>' } },
  });

  const new13 = { a: { fileId: 'FILE-ID1' } };
  const old13 = {};
  expect(() =>
    normalize8baseDocumentDeleteAndUpdate(new13, 'a', old13),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentDeleteAndUpdate:newFile: object is not a valid file as it doesn't contain a valid filename property.`,
    ),
  );
...
test('normalize8baseDocumentsDeleteAndUpdate:', () => {
  expect(() => normalize8baseDocumentsDeleteAndUpdate({}, '', {})).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsDeleteAndUpdate:key: value: can't be blank, null or undefined.`,
    ),
  );
  ...
  const oldO3 = { a: 1 };
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(newO3, 'a', oldO3),
  ).toThrowError(
    new ValidationError(
  ...
  const oldO4 = { a: '1' };
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(newO4, 'a', oldO4),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsDeleteAndUpdate:oldFiles: object is not a List.`,
    ),
  ...
  const oldO5 = { a: {} };
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(newO5, 'a', oldO5),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsDeleteAndUpdate:oldFiles: object is not a List.`,
    ),
  ...
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(newO7, 'a', oldO7),
  ).toThrowError(
    new ValidationError(
  ...
  const oldO8 = { a: [{ id: 'FILE-ID' }] };
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(newO8, 'a', oldO8),
  ).toThrowError(
    new ValidationError(
  ...
  const oldO9 = { a: [{ id: 'FILE-ID' }] };
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(newO9, 'a', oldO9),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsDeleteAndUpdate:newFiles: object is not a List.`,
    ),
  ...
  const old10 = { a: [{ id: 'FILE-ID' }] };
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(new10, 'a', old10),
  ).toThrowError(
    new ValidationError(
  ...
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(new11, 'a', old11),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsDeleteAndUpdate:newFiles: object is not a valid file as it doesn't contain a valid fileId property.`,
    ),
  ...
  const new15 = {
    a: [
      { fileId: 'FILE-ID1', filename: '<FILENAME1>' },
      {
        id: 'ID2',
        fileId: 'FILE-ID2',
        filename: '<FILENAME2>',
  ...
  const new16 = {
    a: [
      { fileId: 'FILE-ID1' },
      { id: 'ID2', fileId: 'FILE-ID2', filename: '<FILENAME2>' },
    ],
  };
  const old16 = { a: [{ id: 'FILE-ID2' }, { id: 'ID2' }] };
  expect(() =>
    normalize8baseDocumentsDeleteAndUpdate(new16, 'a', old16),
  ).toThrowError(
    new ValidationError(
      `normalize8baseDocumentsDeleteAndUpdate:newFiles: object is not a valid file as it doesn't contain a valid filename property.`,
    ),
  );
});
